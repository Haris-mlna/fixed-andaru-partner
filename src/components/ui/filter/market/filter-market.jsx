	...
	return (
		<>
			...
			<div className='flex gap-2 px-4 pb-2'>
				<button className='shadow py-1 px-4 rounded-full hover:bg-blue-400 transition-all duration-150 hover:text-white text-sm text-slate-700'>
					Produk
				</button>
				<button className='shadow py-1 px-4 rounded-full hover:bg-blue-400 transition-all duration-150 hover:text-white text-sm text-slate-700'>
					Manufaktur
